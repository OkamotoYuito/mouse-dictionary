...
const JapaneseTextResource: TextResource = {
  ...
  pdfSettings: "PDF設定",
  persistPdf: "Web PDFを保存する（未使用7日間で自動削除）",
  savedPdfList: "保存したPDF",
  noSavedPdf: "保存したPDFはありません",
  openSavedPdf: "開く",
  deletePdf: "削除",
  clearPdfCache: "保存したPDFをすべて削除",
  pdfCacheLastUsed: "最終使用: {{{date}}}",
  pdfCacheExpires: "自動削除: {{{date}}}",
  pdfLinkTarget: "PDF内リンクの開き方",
  pdfLinkTargetSelf: "現在のタブで開く",
  pdfLinkTargetBlank: "新しいタブで開く",
