...
const EnglishTextResource: TextResource = {
  ...
  persistPdf: "Save web PDFs permanently (delete after 7 days without use)",
  savedPdfList: "Saved PDFs",
  noSavedPdf: "No saved PDFs",
  openSavedPdf: "Open",
  deletePdf: "Delete",
  clearPdfCache: "Delete all saved PDFs",
  pdfCacheLastUsed: "Last opened: {{{date}}}",
  pdfCacheExpires: "Auto-delete: {{{date}}}",
